            ...
            <div class="content-dia">
                <el-form ref="formNew" :model="formNew" label-width="80px">
                    ...
                    <el-form-item label="其他备注" prop="remark">
                        <el-input type="textarea" reset="none" :rows="7" placeholder="请输入内容" v-model="formNew.remark"
        ...
        return {
            ...
            table: {
                ...
                header: [
                    ...
                    {
                        prop: "operationType", label: "运算类型", width: "120px", status: true, filters: (val) => val == 1 ? '+' : '-'
